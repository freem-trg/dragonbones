 ...
 */
@:allow(dragonBones) @:final class GameStarlingFactory extends BaseFactory
{
	/**
	 * @private
	 */
	private static var _eventManager:GameStarlingArmatureDisplay = new GameStarlingArmatureDisplay();
	/**
	 * @private
	 */
	 ...
	 */
	public static var factory:GameStarlingFactory = new GameStarlingFactory();
	/**
	 * @private
	 */
	...
	override private function _generateArmature(dataPackage:BuildArmaturePackage):Armature
	{
		...
		var armatureDisplay:GameStarlingArmatureDisplay = new GameStarlingArmatureDisplay();
	...
	override private function _generateSlot(dataPackage:BuildArmaturePackage, skinSlotData:SkinSlotData, armature:Armature):Slot
	{
		...
		slot._init(skinSlotData, new GameImage(null), new Mesh(slot._vertexData, slot._indexData));
		#else
		slot._init(skinSlotData, new GameImage(StarlingSlot.getEmptyTexture()), null);
		#end
	 ...
	 */
	public function buildArmatureDisplay(armatureName:String, dragonBonesName:String = null, skinName:String = null, textureAtlasName:String = null):GameStarlingArmatureDisplay
	{
	...
	public function getTextureDisplay(textureName:String, textureAtlasName:String = null):Image 
	{
		...
		if (textureData != null)
		{
			...
			return new GameImage(textureData.texture);
		}
	 ...
	 * @version DragonBones 4.5
	 */
	public var soundEventManager(get, never):GameStarlingArmatureDisplay;
	private function get_soundEventManager(): GameStarlingArmatureDisplay
	{
